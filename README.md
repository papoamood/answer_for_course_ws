...
Пример с очередями в файле [queue_example.py](https://github.com/papoamood/answer_for_course_ws/blob/main/queue_example.py). Почитайте код и комментарии, думаю подход понятен.
