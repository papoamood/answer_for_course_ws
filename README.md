...
1. Только один тред может исполнять код в один момент времени. Даже на нескольких ядрах. Т.е. истинный параллелизм используя Thread python невозможен, потому-что GIL (Global Interpreter Lock).
